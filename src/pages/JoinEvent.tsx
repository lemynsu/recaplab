  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="text-3xl font-display font-bold text-foreground mb-2">Join an Event</h1>
        <p className="text-muted-foreground mb-8">Paste an event link or enter an access code.</p>
        ...
        <form onSubmit={handleJoin} className="space-y-4">
          ...
          />
          <Button type="submit" variant="hero" size="lg" className="w-full" disabled={loading || !query.trim()}>
